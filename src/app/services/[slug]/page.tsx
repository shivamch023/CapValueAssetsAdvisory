                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col gap-4 justify-center">
                        <div className="flex items-center gap-2 bg-yellow-600/10 border border-yellow-700/10 backdrop-blur-lg px-4 py-1.5 rounded-full w-max">
                            ...
                            <p className="text-[13px] text-[#C9A240] font-bold">{service.title}</p>
                        </div>
                        ...
                        <div className="flex flex-col xs:w-[70%] text-center md:w-auto sm:flex-row gap-4 mt-4">
                            <Link href="/contact">
                                <button className="flex cursor-pointer text-center text-[14px] items-center gap-2 bg-[#C9A240] text-gray-900 px-6 py-3 rounded-md font-semibold hover:opacity-90 transition w-full sm:w-auto">
